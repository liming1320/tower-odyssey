...
(function () {
    ...
    window.PK32Puzzle.startGame = function (container, name, opts) { if (String(name || '') === '连结电线二') return connectWires2(container); return dispatch(container, String(name || NAMES[0]), opts || {}); };
