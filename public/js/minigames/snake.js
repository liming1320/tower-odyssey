...
MiniGames.snake = {
    LEVELS: [
        ...
        { name: '启程', desc: '10×10 · 目标长度 6 · 速度 300ms' },
        { name: '熟悉', desc: '12×12 · 目标长度 8 · 速度 279ms' },
        { name: '小成', desc: '14×14 · 目标长度 10 · 速度 259ms' },
        { name: '熟练', desc: '14×14 · 目标长度 12 · 速度 241ms' },
        { name: '稳健', desc: '16×16 · 目标长度 14 · 速度 224ms' },
        { name: '提速', desc: '16×16 · 目标长度 16 · 速度 208ms' },
        { name: '进阶', desc: '18×18 · 目标长度 18 · 速度 194ms' },
        { name: '进阶 II', desc: '18×18 · 目标长度 20 · 速度 180ms' },
        { name: '挑战', desc: '20×20 · 目标长度 22 · 速度 167ms' },
        { name: '挑战 II', desc: '20×20 · 目标长度 24 · 速度 156ms' },
        { name: '高手', desc: '22×22 · 目标长度 26 · 速度 145ms' },
        { name: '高手 II', desc: '22×22 · 目标长度 28 · 速度 135ms' },
        { name: '疾速', desc: '24×24 · 目标长度 30 · 速度 125ms' },
        { name: '闪电', desc: '24×24 · 目标长度 32 · 速度 116ms' },
        { name: '狂飙', desc: '26×26 · 目标长度 34 · 速度 108ms' },
        { name: '大师', desc: '26×26 · 目标长度 36 · 速度 100ms' },
        { name: '宗匠', desc: '28×28 · 目标长度 38 · 速度 93ms' },
        { name: '鬼手', desc: '28×28 · 目标长度 40 · 速度 87ms' },
        { name: '传奇', desc: '30×30 · 目标长度 42 · 速度 81ms' },
        { name: '贪吃王', desc: '32×32 · 目标长度 45 · 速度 75ms · 终极' },
    ],
    // [cols, rows, target, speed(ms/格)]
    // 难度曲线（2026-09-11 二次重调）：第 1 关 130ms → 200ms → **300ms**。
    // 200ms（≈5 格/秒）在 10×10 小图上仍偏快：横穿全图只要 2 秒，新手来不及反应。
    // 现改 300ms（≈3.3 格/秒）起步，末关 75ms 依旧高压；
    // 全程按等比递减（每关约 ×0.93），前段几乎不提速、后段才逐级收紧。
    PARAMS: [
        [10, 10, 6, 300], [12, 12, 8, 279], [14, 14, 10, 259], [14, 14, 12, 241], [16, 16, 14, 224],
        [16, 16, 16, 208], [18, 18, 18, 194], [18, 18, 20, 180], [20, 20, 22, 167], [20, 20, 24, 156],
        [22, 22, 26, 145], [22, 22, 28, 135], [24, 24, 30, 125], [24, 24, 32, 116], [26, 26, 34, 108],
        [26, 26, 36, 100], [28, 28, 38, 93], [28, 28, 40, 87], [30, 30, 42, 81], [32, 32, 45, 75],
    ],
