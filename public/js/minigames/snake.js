...
MiniGames.snake = {
    LEVELS: [
        ...
        { name: '启程', desc: '10×10 · 目标长度 6 · 速度 200ms' },
        { name: '熟悉', desc: '12×12 · 目标长度 8 · 速度 190ms' },
        { name: '小成', desc: '14×14 · 目标长度 10 · 速度 180ms' },
        { name: '熟练', desc: '14×14 · 目标长度 12 · 速度 172ms' },
        { name: '稳健', desc: '16×16 · 目标长度 14 · 速度 164ms' },
        { name: '提速', desc: '16×16 · 目标长度 16 · 速度 156ms' },
        { name: '进阶', desc: '18×18 · 目标长度 18 · 速度 148ms' },
        { name: '进阶 II', desc: '18×18 · 目标长度 20 · 速度 140ms' },
        { name: '挑战', desc: '20×20 · 目标长度 22 · 速度 132ms' },
        { name: '挑战 II', desc: '20×20 · 目标长度 24 · 速度 124ms' },
        { name: '高手', desc: '22×22 · 目标长度 26 · 速度 116ms' },
        { name: '高手 II', desc: '22×22 · 目标长度 28 · 速度 110ms' },
        { name: '疾速', desc: '24×24 · 目标长度 30 · 速度 104ms' },
        { name: '闪电', desc: '24×24 · 目标长度 32 · 速度 98ms' },
        { name: '狂飙', desc: '26×26 · 目标长度 34 · 速度 92ms' },
        { name: '大师', desc: '26×26 · 目标长度 36 · 速度 86ms' },
        { name: '宗匠', desc: '28×28 · 目标长度 38 · 速度 80ms' },
        { name: '鬼手', desc: '28×28 · 目标长度 40 · 速度 74ms' },
        { name: '传奇', desc: '30×30 · 目标长度 42 · 速度 68ms' },
        { name: '贪吃王', desc: '32×32 · 目标长度 45 · 速度 62ms · 终极' },
    ],
    // [cols, rows, target, speed(ms/格)]
    // 2026-09-10 难度曲线重调：原第 1 关 130ms（≈7.7 格/秒）对新手过快，
    // 现改为 200ms（≈5 格/秒）起步，末关 62ms 仍有高压；中段按「每关约 -6ms」平滑收紧。
    PARAMS: [
        [10, 10, 6, 200], [12, 12, 8, 190], [14, 14, 10, 180], [14, 14, 12, 172], [16, 16, 14, 164],
        [16, 16, 16, 156], [18, 18, 18, 148], [18, 18, 20, 140], [20, 20, 22, 132], [20, 20, 24, 124],
        [22, 22, 26, 116], [22, 22, 28, 110], [24, 24, 30, 104], [24, 24, 32, 98], [26, 26, 34, 92],
        [26, 26, 36, 86], [28, 28, 38, 80], [28, 28, 40, 74], [30, 30, 42, 68], [32, 32, 45, 62],
    ],
