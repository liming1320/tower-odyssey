...
fs.writeFileSync(path.join(__dirname, '..', 'public', 'data', 'pk32-fly-hundred-levels.json'), JSON.stringify({ name: catalog.name, nativeLevelCount: null, extractedPayloadCount: levels.length, levels }, null, 2) + '\n', 'utf8');
