...
fs.writeFileSync(path.join(__dirname, '..', 'public', 'data', 'pk32-seven-lamps-levels.json'), JSON.stringify({ name: catalog.name, nativeLevelCount: null, extractedPayloadCount: levels.length, levels }, null, 2) + '\n', 'utf8');
