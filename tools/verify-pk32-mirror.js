...
const data = require('../public/data/pk32-mirror-levels.json');
...
check('payload matches catalog', data.levels[0].offset === catalog.payloadSamples[0].offset && data.levels[0].cells.length === 102);
