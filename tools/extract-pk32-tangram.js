...
fs.writeFileSync(path.join(__dirname, '..', 'public', 'data', 'pk32-tangram-levels.json'), JSON.stringify({ name: catalog.name, nativeLevelCount: catalog.levelCount, extractedLevelCount: levels.length, puzzlesPerLevel: 10, levels }, null, 2) + '\n', 'utf8');
