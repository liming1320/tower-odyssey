...
fs.writeFileSync(path.join(__dirname, '..', 'public', 'data', 'pk32-burst-balls-levels.json'), JSON.stringify({ name: catalog.name, nativeLevelCount: null, extractedPayloadCount: levels.length, rules: catalog.help.slice(0, 2), levels }, null, 2) + '\n', 'utf8');
