...
fs.writeFileSync(path.join(__dirname, '..', 'public', 'data', 'pk32-sync-move-levels.json'), JSON.stringify({ name: catalog.name, nativeLevelCount: null, extractedPayloadCount: levels.length, rules: catalog.help, levels }, null, 2) + '\n', 'utf8');
