...
fs.writeFileSync(path.join(root, 'public/data/pk32-pick-flowers-levels.json'), JSON.stringify({ version: 1, name: '摘花朵', source: 'PK32 native module.bin', count: levels.length, fullGameRulesVerified: false, levels }, null, 2) + '\n');
