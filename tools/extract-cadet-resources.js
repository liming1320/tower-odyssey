...
const wanted = {
    ...
    588: 'cadet-rebound-1.png',
    589: 'cadet-rebound-2.png',
    590: 'cadet-rebound-3.png',
    591: 'cadet-rebound-4.png',
    618: 'cadet-gate-1.png',
    619: 'cadet-gate-2.png',
    600: 'cadet-flag-1.png',
    608: 'cadet-flag-2.png',
};
const liteGroups = [
    234, 235, 238, 241, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276, 277, 278, 279, 280, 281, 282, 283, 284, 285, 286, 287, 288, 289, 290, 291, 292, 293, 294, 295, 296, 297, 298, 299, 300, 301, 302, 303, 304, 305, 306, 307, 308, 309, 310, 311, 312, 313, 314, 315, 316, 317, 318, 319, 320, 321, 322, 323, 324, 325, 326, 327, 328, 329, 330, 331, 332, 333, 334, 335, 336, 337, 338, 339, 340, 341, 342, 344, 345, 346, 347, 348, 349, 350, 351, 352, 353, 354, 355, 356, 357, 358, 359, 360, 361, 362, 363, 364, 365, 366, 367, 368, 369, 370, 371, 372, 373, 374, 375, 376, 377, 378, 379
];
liteGroups.forEach(group => { wanted[group] = `cadet-lite-${group}.png`; });
for (let group = 637; group <= 647; group++) wanted[group] = `cadet-roll-${group}.png`;
for (let frame = 1; frame <= 9; frame++) wanted[550 + frame] = `cadet-target-${frame}.png`;
