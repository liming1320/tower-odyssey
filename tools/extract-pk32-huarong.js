...
fs.writeFileSync(path.join(root, 'public/data/pk32-huarong-levels.json'), JSON.stringify({ version: 1, source: 'PK32 native module.bin', count: levels.length, fullGameRulesVerified: false, levels }, null, 2) + '\n');
