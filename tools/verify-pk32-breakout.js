const catalog = require('../public/data/pk32-native-catalog.json').records.find(x => x.name === '打砖块');
const data = require('../public/data/pk32-breakout-levels.json');
...
check('payload count is 44', data.extractedPayloadCount === 44 && data.levels.length === 44);
