...
fs.writeFileSync(path.join(__dirname, '..', 'public', 'data', 'pk32-sea-treasure-levels.json'), JSON.stringify({ name: catalog.name, nativeLevelCount: null, extractedPayloadCount: levels.length, controls: catalog.help, levels }, null, 2) + '\n', 'utf8');
