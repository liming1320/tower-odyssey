...
fs.writeFileSync(path.join(__dirname, '..', 'public', 'data', 'pk32-zen-maze-levels.json'), JSON.stringify({ name: catalog.name, nativeLevelCount: catalog.levelCount, extractedPayloadCount: levels.length, jumpCost: 20, levels }, null, 2) + '\n', 'utf8');
