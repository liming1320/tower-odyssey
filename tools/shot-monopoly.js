...
(async () => {
    ...
    const info1 = await cdp.eval(`(()=>{
        ...
        return { three:gl.three, threeRev:gl.threeRev, tiles:gl.tiles, pawns:gl.pawns, hasBoard:gl.hasBoard,
    ...
    const pass = okThree && okLoop && okCanvas && okTiles && okPawns && okBld && okPawn && okPawnVis && okCam && okPlay && okNoErr;
    console.log(pass ? '\n✅ 大富翁真 3D 渲染通过' : '\n❌ 存在问题需修复');
